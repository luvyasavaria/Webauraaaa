      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0 bg-[#0a0a0a]">
          <video
            ...
            playsInline
            preload="auto"
            poster="/images/isittuesdayyet.png"
            className="w-full h-full object-cover opacity-50"
          >
            <source src="/videos/landingpagevid.mp4" type="video/mp4" />
          </video>
      ...
      <section className="py-20 md:py-32 px-6 bg-[#050505]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              { title: 'Is it Tuesday yet?', category: 'Web Application', img: '/images/isittuesdayyet.png', url: 'https://isittuesdayyet.netlify.app/' },
              { title: 'Doneify', category: 'Productivity Tool', img: '/images/doneify.png', url: 'https://luvyasavaria.github.io/doneify/' },
            ].map((project, i) => (
              <motion.a
                key={i}
                href={project.url}
